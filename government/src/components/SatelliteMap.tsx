                ...
                <Popup>
                  <div className="p-3 min-w-[200px] border-none shadow-none">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-bold text-sm uppercase">Regional Projection</span>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center bg-muted/30 p-2 rounded-lg">
                        <span className="text-xs">Forecast AQI</span>
                        <span className="font-bold text-lg" style={{ color: getAQIColor(forecast.current_aqi) }}>
                          {forecast.current_aqi}
                        </span>
                      </div>
                      <p className="text-[10px] leading-tight text-muted-foreground">
                        Atmospheric column analysis based on Sentinel-5P TROPOMI data and predictive ML modeling.
                      </p>
                    </div>
                  </div>
                </Popup>
